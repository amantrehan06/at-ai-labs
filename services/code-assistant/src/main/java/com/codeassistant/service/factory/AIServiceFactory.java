...
public class AIServiceFactory {
     ...
     * Priority order: OpenAI > Groq (for Llama) > Mock (for testing)
     * 
    ...
    public AIChatService getBestAvailableService() throws AIServiceException {
        // Priority order: OpenAI > Groq (for Llama) > Mock
        ...
        if (availableServices.containsKey("MockAIChatService")) {
            logger.debug("Using Mock AI service (testing mode)");
            return availableServices.get("MockAIChatService");
        }
     ...
     * 
     * @param serviceName The name of the service (e.g., "OpenAIChatService", "LlamaAIChatService")
